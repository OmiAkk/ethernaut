...
Подготовь свой кошелёк в расширении и выбери желаемую сеть слева вверху в интерфейсе расширения. Вы также можете использовать кнопку пользовательского интерфейса чтобы переключать сети. Если вы выберете неподдерживаемую сеть, игра уведомит вас об этом и переключит кошелёк на стандартную сеть Goerli testnet.
